...
export const __Uint8Array_prototype_toBase64 = (
  _this: Uint8Array,
  ...
  if (
    !Porffor.strcmp(alphabet, "base64") &&
    !Porffor.strcmp(alphabet, "base64url")
  ) {
  ...
  while (i < fullChunks) {
    ...
    Porffor.wasm.i32.store8(
      j++,
      Porffor.wasm.i32.load8_u(alphabetPtr + enc1, 0, 4),
      0,
      4,
    )
    Porffor.wasm.i32.store8(
      j++,
      Porffor.wasm.i32.load8_u(alphabetPtr + enc2, 0, 4),
      0,
      4,
    )
    Porffor.wasm.i32.store8(
      j++,
      Porffor.wasm.i32.load8_u(alphabetPtr + enc3, 0, 4),
      0,
      4,
    )
    Porffor.wasm.i32.store8(
      j++,
      Porffor.wasm.i32.load8_u(alphabetPtr + enc4, 0, 4),
      0,
      4,
    )
  }
...
export const __Uint8Array_prototype_toHex = (_this: Uint8Array) => {
  ...
  while (i < len) {
    ...
    Porffor.wasm.i32.store8(
      j++,
      Porffor.wasm.i32.load8_u(hexPtr + (byte >> 4), 0, 4),
      0,
      4,
    )
    Porffor.wasm.i32.store8(
      j++,
      Porffor.wasm.i32.load8_u(hexPtr + (byte & 15), 0, 4),
      0,
      4,
    )
  }
...
export const __Porffor_fromBase64 = (
  str: any,
  alphabet: any,
  lastChunkHandling: any,
  destPtr: i32,
  maxLength: i32,
) => {
...
export const __Uint8Array_fromBase64 = (str: any, options: any = undefined) => {
  ...
  if (
    !Porffor.strcmp(lastChunkHandling, "loose") &&
    !Porffor.strcmp(lastChunkHandling, "strict") &&
    !Porffor.strcmp(lastChunkHandling, "stop-before-partial")
  ) {
...
export const __Uint8Array_prototype_setFromBase64 = (
  _this: Uint8Array,
  str: any,
  options: any = undefined,
) => {
  ...
  const result: i32 = __Porffor_fromBase64(
    str,
    alphabet,
    lastChunkHandling,
    bufferPtr,
...
// Returns packed: (charsRead << 16) | bytesWritten
export const __Porffor_fromHex = (
  str: bytestring,
  destPtr: i32,
  maxLength: i32,
) => {
  ...
  while (i < limit) {
    ...
    if (h1 >= 48 && h1 <= 57)
      v1 = h1 - 48 // 0-9
    else if (h1 >= 97 && h1 <= 102)
      v1 = h1 - 87 // a-f
    else if (h1 >= 65 && h1 <= 70) v1 = h1 - 55 // A-F

    if (h2 >= 48 && h2 <= 57)
      v2 = h2 - 48 // 0-9
    else if (h2 >= 97 && h2 <= 102)
      v2 = h2 - 87 // a-f
...
export const __Uint8Array_prototype_setFromHex = (
  _this: Uint8Array,
  str: any,
) => {
  if (Porffor.type(str) !== Porffor.TYPES.bytestring) {
