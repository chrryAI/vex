...
export const WeakRef = function (target: any): WeakRef {
  ...
  if (!Porffor.object.isObjectOrSymbol(target))
    throw new TypeError("Target for WeakRef needs to be an object or symbol")
...
export const __WeakRef_prototype_toString = (_this: WeakRef) =>
  "[object WeakRef]"
export const __WeakRef_prototype_toLocaleString = (_this: WeakRef) =>
  __WeakRef_prototype_toString(_this)
