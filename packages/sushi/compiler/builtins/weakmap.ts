...
export const __WeakMap_prototype_set = (
  _this: WeakMap,
  key: any,
  value: any,
) => {
  if (!Porffor.object.isObjectOrSymbol(key))
    throw new TypeError("Value in WeakSet needs to be an object or symbol")
...
export const __WeakMap_prototype_toString = (_this: WeakMap) =>
  "[object WeakMap]"
export const __WeakMap_prototype_toLocaleString = (_this: WeakMap) =>
  __WeakMap_prototype_toString(_this)

// https://github.com/tc39/proposal-upsert
export const __WeakMap_prototype_getOrInsert = (
  _this: WeakMap,
  key: any,
  value: any,
) => {
...
export const __WeakMap_prototype_getOrInsertComputed = (
  _this: WeakMap,
  key: any,
  callbackFn: any,
) => {
