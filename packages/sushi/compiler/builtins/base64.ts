...
export const btoa = (input: bytestring): bytestring => {
  ...
  while (i < endPtr) {
    ...
    Porffor.wasm.i32.store8(
      j++,
      Porffor.wasm.i32.load8_u(keyStrPtr + enc1, 0, 4),
      0,
      4,
    )
    Porffor.wasm.i32.store8(
      j++,
      Porffor.wasm.i32.load8_u(keyStrPtr + enc2, 0, 4),
      0,
      4,
    )
    Porffor.wasm.i32.store8(
      j++,
      Porffor.wasm.i32.load8_u(keyStrPtr + enc3, 0, 4),
      0,
      4,
    )
    Porffor.wasm.i32.store8(
      j++,
      Porffor.wasm.i32.load8_u(keyStrPtr + enc4, 0, 4),
      0,
      4,
    )
  }
...
export const atob = (input: bytestring): bytestring => {
  ...
  while (i < endPtr) {
    const enc1: i32 = Porffor.wasm.i32.load8_u(
      lutPtr + Porffor.wasm.i32.load8_u(i++, 0, 4),
      0,
      4,
    )
    const enc2: i32 =
      i < endPtr
        ? Porffor.wasm.i32.load8_u(
            lutPtr + Porffor.wasm.i32.load8_u(i++, 0, 4),
            0,
            4,
          )
