...
export const __Object_fromEntries = (iterable: any): object => {
  ...
  for (const x of iterable) {
    if (!Porffor.object.isObject(x))
      throw new TypeError("Iterator contains non-object")
    out[x[0]] = x[1]
  }
...
export const __Porffor_object_instanceof = (
  obj: any,
  constr: any,
  checkProto: any,
): boolean => {
...
export const __Object_assign = (target: any, ...sources: any[]): any => {
  if (target == null)
    throw new TypeError("Argument is nullish, expected object")
...
export const __Object_prototype_propertyIsEnumerable = (
  _this: any,
  prop: any,
) => {
  if (_this == null) throw new TypeError("Argument is nullish, expected object")
...
export const __Object_getOwnPropertyDescriptor = (
  obj: any,
  prop: any,
): object | undefined => {
  if (obj == null) throw new TypeError("Argument is nullish, expected object")
...
export const __Object_defineProperty = (
  target: any,
  prop: any,
  desc: any,
): any => {
  ...
  if (get !== undefined || set !== undefined) {
    ...
    if (value !== undefined || writable !== undefined) {
      throw new TypeError(
        "Descriptor cannot define both accessor and data descriptor attributes",
      )
    }
  ...
  if (existingDesc) {
    ...
    if (configurable == null && !("configurable" in desc))
      configurable = existingDesc.configurable
    if (enumerable == null && !("enumerable" in desc))
    ...
    if (accessor) {
      ...
      if (writable == null && !("writable" in desc))
...
export const __Object_defineProperties = (target: any, props: any): any => {
  if (!Porffor.object.isObject(target))
    throw new TypeError("Target is a non-object")
  if (!Porffor.object.isObjectOrSymbol(props))
    throw new TypeError("Props needs to be an object or symbol")
...
export const __Object_create = (proto: any, props: any): object => {
  if (!Porffor.object.isObjectOrNull(proto))
...
export const __Object_setPrototypeOf = (obj: any, proto: any): any => {
  ...
  if (Porffor.object.isObject(obj) && Porffor.object.isInextensible(obj)) {
    const currentProto: any = Porffor.object.getPrototypeWithHidden(
      obj,
      Porffor.type(obj),
    )
    if (proto !== currentProto)
      throw new TypeError("Cannot set prototype of non-extensible object")
  }
...
export const __Object_prototype_toLocaleString = (_this: any) =>
  __Object_prototype_toString(_this)
...
export const __Porffor_object_rest = (
  dst: object,
  src: any,
  ...blocklist: any[]
): object => {
