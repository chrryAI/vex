...
export const __Porffor_Generator_return = (
  vals: any[],
  value: any,
): __Porffor_Generator => {
  vals.length = 1
...
export const __Porffor_Generator_prototype_return = (
  vals: any[],
  value: any,
) => {
  vals.length = 1
...
export const __Porffor_Generator_prototype_throw = (
  vals: any[],
  value: any,
) => {
  vals.length = 0
...
export const __Porffor_AsyncGenerator = (
  values: any[],
): __Porffor_AsyncGenerator => {
  return values as __Porffor_AsyncGenerator
}

export const __Porffor_AsyncGenerator_yield = (
  vals: any[],
  value: any,
): void => {
  const len: i32 = Porffor.array.fastPush(vals, value)
...
export const __Porffor_AsyncGenerator_return = (
  vals: any[],
  value: any,
): __Porffor_AsyncGenerator => {
  vals.length = 1
...
export const __Porffor_AsyncGenerator_prototype_return = async (
  vals: any[],
  value: any,
) => {
  vals.length = 1
...
export const __Porffor_AsyncGenerator_prototype_throw = async (
  vals: any[],
  value: any,
) => {
  vals.length = 0
