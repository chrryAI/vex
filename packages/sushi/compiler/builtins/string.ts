  ...
  if (Porffor.wasm`local.get ${a + 1}` === Porffor.TYPES.bytestring) {
    if (Porffor.wasm`local.get ${b + 1}` === Porffor.TYPES.bytestring) {
      ...
      Porffor.wasm.memory.copy(
        Porffor.wasm`local.get ${out}` + 4,
        Porffor.wasm`local.get ${a}` + 4,
        al,
        0,
        0,
      )
      ...
      Porffor.wasm.memory.copy(
        Porffor.wasm`local.get ${out}` + 4 + al,
        Porffor.wasm`local.get ${b}` + 4,
        bl,
        0,
        0,
      )
      ...
      for (let i: i32 = 0; i < al; i++) {
        Porffor.wasm.i32.store16(
          Porffor.wasm`local.get ${out}` + i * 2,
          Porffor.wasm.i32.load8_u(Porffor.wasm`local.get ${a}` + i, 0, 4),
          0,
          4,
        )
      ...
      // copy right (fast memcpy)
      Porffor.wasm.memory.copy(
        Porffor.wasm`local.get ${out}` + 4 + al * 2,
        Porffor.wasm`local.get ${b}` + 4,
        bl * 2,
        0,
        0,
      ...
      if (padStringLen > 0) {
        for (let i: i32 = 0; i < todo; i++) {
          Porffor.wasm.i32.store16(
            outPtr,
            Porffor.wasm.i32.load16_u(
              Porffor.wasm`local.get ${padString}` + (i % padStringLen) * 2,
              0,
              4,
            ),
            0,
        ...
        for (let i: i32 = 0; i < todo; i++) {
          Porffor.wasm.i32.store8(
            ...
            Porffor.wasm.i32.load8_u(
              Porffor.wasm`local.get ${padString}` + (i % padStringLen),
              0,
              4,
            ),
            0,
