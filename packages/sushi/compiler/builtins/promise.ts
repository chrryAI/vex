...
export const __ecma262_NewPromiseReactionJob = (
  reaction: any[],
  argument: any,
): any[] => {
...
export const __ecma262_TriggerPromiseReactions = (
  reactions: any[],
  argument: any,
): void => {
  ...
  for (const reaction of reactions) {
    ...
    __ecma262_HostEnqueuePromiseJob(
      __ecma262_NewPromiseReactionJob(reaction, argument),
    )
  }
...
export const __Porffor_promise_newReaction = (
  handler: Function,
  promise: any,
  flags: i32,
): any[] => {
...
export const __Porffor_then = (
  ...
  if (state == 0) {
    ...
    __ecma262_HostEnqueuePromiseJob(
      __ecma262_NewPromiseReactionJob(fulfillReaction, value),
    )
  } else {
    // rejected
    // 11. Else,
    ...
    __ecma262_HostEnqueuePromiseJob(
      __ecma262_NewPromiseReactionJob(rejectReaction, reason),
    )
  }
}
...
export const __Porffor_promise_resolve = (value: any, promise: any): void => {
  ...
  if (__ecma262_IsPromise(value)) {
    const fulfillReaction: any[] = __Porffor_promise_newReaction(
      __Porffor_promise_noop,
      promise,
      0,
    )
    const rejectReaction: any[] = __Porffor_promise_newReaction(
      __Porffor_promise_noop,
      promise,
      2,
    )
...
export const __Porffor_promise_runNext = (func: Function): void => {
  ...
  __ecma262_HostEnqueuePromiseJob(
    __ecma262_NewPromiseReactionJob(reaction, undefined),
  )
}
...
export const __Porffor_promise_resolveActive = (value: any): void =>
  __Porffor_promise_resolve(value, activePromise)
export const __Porffor_promise_rejectActive = (reason: any): void =>
  __Porffor_promise_reject(reason, activePromise)
...
export const __Promise_prototype_then = (
  _this: any,
  onFulfilled: any,
  onRejected: any,
) => {
...
export const __Promise_prototype_finally = (_this: any, onFinally: any) => {
  ...
  const finallyReaction: any[] = __Porffor_promise_newReaction(
    onFinally,
    outPromise,
    1,
  )
  ...
  if (state == 0) {
    ...
    const value: any = promise[0]
    __ecma262_HostEnqueuePromiseJob(
      __ecma262_NewPromiseReactionJob(finallyReaction, value),
    )
  }
...
export const __Promise_prototype_toLocaleString = (_this: any) =>
