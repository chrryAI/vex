...
export const __Set_prototype_forEach = (
  _this: Set,
  callbackFn: any,
...
export const __Set_prototype_union = (_this: Set, other: any) => {
  if (Porffor.type(other) !== Porffor.TYPES.set)
    throw new TypeError("other argument must be a Set")
...
export const __Set_prototype_toLocaleString = (_this: Set) =>
  __Set_prototype_toString(_this)
