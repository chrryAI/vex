...
export const __Map_prototype_forEach = (
  _this: Map,
  callbackFn: any,
...
export const __Map_prototype_toLocaleString = (_this: Map) =>
  __Map_prototype_toString(_this)

// https://github.com/tc39/proposal-upsert
export const __Map_prototype_getOrInsert = (
  _this: Map,
  key: any,
  value: any,
) => {
...
export const __Map_prototype_getOrInsertComputed = (
  _this: Map,
  key: any,
  callbackFn: any,
) => {
