...
export const __Porffor_printHexDigit = (arg: number): void => {
  switch (arg) {
    case 0xf:
      Porffor.printStatic("f")
      return
    case 0xe:
      Porffor.printStatic("e")
      return
    case 0xd:
      Porffor.printStatic("d")
      return
    case 0xc:
      Porffor.printStatic("c")
      return
    case 0xb:
      Porffor.printStatic("b")
      return
    case 0xa:
      Porffor.printStatic("a")
      return
...
export const __Porffor_print = (
  arg: any,
  colors: boolean = true,
  depth: number = 0,
): void => {
  const __Porffor_printArray = (
    arg:
      | any[]
      | Uint8Array
      | Int8Array
    ...
    case Porffor.TYPES.object:
      if (arg) {
        ...
        for (let i: i32 = 0; i <= len; i++) {
          ...
          Porffor.printStatic(": ")
          __Porffor_print(
            Porffor.object.get(arg, ecma262.ToPropertyKey(x)),
            colors,
            depth + 1,
          )
...
export const __console_groupCollapsed = (label: bytestring): void =>
  __console_group(label)
...
export const __Porffor_dirObject = (
  obj: any,
  colors: boolean,
  depth: i32,
  showHidden: boolean,
