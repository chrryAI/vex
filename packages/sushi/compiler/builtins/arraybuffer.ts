...
export const ArrayBuffer = function (length: any): ArrayBuffer {
  ...
  if (byteLength > 4294967295)
    throw new RangeError("Invalid ArrayBuffer length (over 32 bit address space)");
...
export const __ArrayBuffer_prototype_slice = (_this: ArrayBuffer, start: any, end: any) => {
  if (_this.detached)
    throw new TypeError("Called ArrayBuffer.prototype.slice on a detached ArrayBuffer");
...
export const __ArrayBuffer_prototype_transfer = (_this: ArrayBuffer, newLength: any) => {
  if (_this.detached)
    throw new TypeError("Called ArrayBuffer.prototype.transfer on a detached ArrayBuffer");
...
export const __ArrayBuffer_prototype_transferToFixedLength = (_this: ArrayBuffer, newLength: any) =>
...
export const SharedArrayBuffer = function (length: any): SharedArrayBuffer {
  ...
  if (byteLength > 4294967295)
    throw new RangeError("Invalid SharedArrayBuffer length (over 32 bit address space)");
