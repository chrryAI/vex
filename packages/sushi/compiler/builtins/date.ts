...
export const __ecma262_Modulo = (x: number, y: number): number =>
  x - Math.floor(x / y) * y
...
export const __ecma262_TimeWithinDay = (t: number): number =>
  __ecma262_Modulo(t, 86400000)
...
export const __ecma262_TimeFromYear = (y: number): number =>
  86400000 * __ecma262_DayFromYear(y)
...
export const __ecma262_DayWithinYear = (t: number): number =>
  __ecma262_Day(t) - __ecma262_DayFromYear(__ecma262_YearFromTime(t))
...
export const __ecma262_WeekDay = (t: number): number =>
  __ecma262_Modulo(__ecma262_Day(t) + 4, 7)
...
export const __ecma262_HourFromTime = (t: number): number =>
  __ecma262_Modulo(Math.floor(t / 3600000), 24)
...
export const __ecma262_MinFromTime = (t: number): number =>
  __ecma262_Modulo(Math.floor(t / 60000), 60)
...
export const __ecma262_SecFromTime = (t: number): number =>
  __ecma262_Modulo(Math.floor(t / 1000), 60)

// 21.4.1.17 msFromTime (t)
// https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-msfromtime
// 1. Return 𝔽(ℝ(t) modulo ℝ(msPerSecond)).
export const __ecma262_msFromTime = (t: number): number =>
  __ecma262_Modulo(t, 1000)
...
export const __ecma262_MakeTime = (
  hour: number,
  min: number,
  sec: number,
  ms: number,
  ...
  return (
    ecma262.ToIntegerOrInfinity(hour) * 3600000 +
...
export const __ecma262_MakeDay = (
  year: number,
  month: number,
  date: number,
): number => {
  ...
  const doe: number =
    yoe * 365 + Math.trunc(yoe / 4) - Math.trunc(yoe / 100) + doy
...
export const __ecma262_WeekDayName = (tv: number): bytestring => {
  ...
  Porffor.wasm.i32.store8(
    outPtr++,
    Porffor.wasm.i32.load8_u(lutPtr++, 0, 4),
    0,
    4,
  )
  Porffor.wasm.i32.store8(
...
export const __ecma262_ParseDTSF = (string: bytestring): number => {
  ...
  while (ptr <= endPtr) {
    // <= to include extra null byte to set last n
...
export const __ecma262_ParseRFC7231OrToString = (
  string: bytestring,
): number => {
  // formats we need to support:
  ...
  if (Porffor.fastAnd(chr >= 48, chr <= 57)) {
    ...
    // date, month name
    while (true) {
      // use >0 check instead of !=' ' to handle malformed
...
export const __Date_prototype_setDate = (_this: any, date: any) => {
  ...
  const newDate: number = __ecma262_MakeDate(
    __ecma262_MakeDay(
      __ecma262_YearFromTime(t),
      __ecma262_MonthFromTime(t),
      dt,
    ),
...
export const __Date_prototype_setFullYear = (
  _this: any,
  year: any,
  month: any,
  date: any,
...
export const __Date_prototype_setHours = (
  _this: any,
  hour: any,
  min: any,
  sec: any,
  ...
  const date: number = __ecma262_MakeDate(
    __ecma262_Day(t),
    __ecma262_MakeTime(h, m, s, milli),
  )
...
export const __Date_prototype_setMilliseconds = (_this: any, ms: any) => {
  ...
  const time: number = __ecma262_MakeTime(
    __ecma262_HourFromTime(t),
    __ecma262_MinFromTime(t),
    __ecma262_SecFromTime(t),
    milli,
  )

  // 8. Let u be TimeClip(UTC(MakeDate(Day(t), time))).
  const u: number = __ecma262_TimeClip(
    __ecma262_UTC(__ecma262_MakeDate(__ecma262_Day(t), time)),
  )
...
export const __Date_prototype_setMinutes = (
  _this: any,
  min: any,
  sec: any,
  ms: any,
  ...
  const date: number = __ecma262_MakeDate(
    __ecma262_Day(t),
    __ecma262_MakeTime(__ecma262_HourFromTime(t), m, s, milli),
  )
...
export const __Date_prototype_setMonth = (
  _this: any,
  month: any,
  date: any,
) => {
  ...
  const newDate: number = __ecma262_MakeDate(
    __ecma262_MakeDay(__ecma262_YearFromTime(t), m, dt),
    __ecma262_TimeWithinDay(t),
  )
...
export const __Date_prototype_setUTCFullYear = (
  _this: any,
  year: any,
  month: any,
  date: any,
...
export const __Date_prototype_setUTCHours = (
  _this: any,
  hour: any,
  min: any,
  sec: any,
...
export const __Date_prototype_setUTCMilliseconds = (_this: any, ms: any) => {
  ...
  const v: number = __ecma262_TimeClip(
    __ecma262_MakeDate(__ecma262_Day(t), time),
  )
...
export const __Date_prototype_setUTCMinutes = (
  _this: any,
  min: any,
  sec: any,
  ms: any,
...
export const __Date_prototype_setUTCMonth = (
  _this: any,
  month: any,
  date: any,
) => {
...
export const __Date_prototype_setUTCSeconds = (
  _this: any,
  sec: any,
  ms: any,
) => {
...
export const __Porffor_bytestring_appendStr = (
  str: bytestring,
  appendage: bytestring,
): i32 => {
  ...
  while (appendagePtr < endPtr) {
    Porffor.wasm.i32.store8(
      strPtr++,
      Porffor.wasm.i32.load8_u(appendagePtr++, 0, 4),
      0,
      4,
    )
  }
...
export const __Porffor_bytestring_appendChar = (
  str: bytestring,
  char: i32,
): i32 => {
...
export const __Porffor_bytestring_append2Char = (
  str: bytestring,
  char1: i32,
  char2: i32,
): i32 => {
...
export const __Porffor_bytestring_appendPadNum = (
  str: bytestring,
  num: number,
  len: number,
): i32 => {
  ...
  while (numPtr < numPtrEnd) {
    Porffor.wasm.i32.store8(
      strPtr++,
      Porffor.wasm.i32.load8_u(numPtr++, 0, 4),
      0,
      4,
    )
  }
...
export const __Date_prototype_toLocaleDateString = (
  _this: any,
  reserved1: any,
  reserved2: any,
) => {
...
export const __Date_prototype_toLocaleString = (
  _this: any,
  reserved1: any,
  reserved2: any,
) => {
...
export const __Date_prototype_toLocaleTimeString = (
  _this: any,
  reserved1: any,
  reserved2: any,
) => {
...
export const Date = function (...values: any[]): bytestring | Date {
  ...
  if (numberOfArgs == 0) {
    ...
    const finalDate: number = __ecma262_MakeDate(
      __ecma262_MakeDay(yr, m, dt),
      __ecma262_MakeTime(h, min, s, milli),
    )
