...
export const __ecma262_MakeDay = (year: number, month: number, date: number): number => {
  ...
  if (Porffor.fastOr(!Number.isFinite(year), !Number.isFinite(month), !Number.isFinite(date)))
    return NaN;
...
export const __ecma262_ParseDTSF = (string: bytestring): number => {
  ...
  return __ecma262_TimeClip(
    __ecma262_MakeDate(__ecma262_MakeDay(y, m, dt), __ecma262_MakeTime(h, min, s, milli)),
  );
};
...
export const __ecma262_ParseRFC7231OrToString = (string: bytestring): number => {
  ...
  return __ecma262_TimeClip(
    __ecma262_MakeDate(__ecma262_MakeDay(y, m, dt), __ecma262_MakeTime(h, min, s, 0)),
  );
};
...
export const __Date_prototype_setDate = (_this: any, date: any) => {
  ...
  const newDate: number = __ecma262_MakeDate(
    __ecma262_MakeDay(__ecma262_YearFromTime(t), __ecma262_MonthFromTime(t), dt),
...
export const __Date_prototype_setSeconds = (_this: any, sec: any, ms: any) => {
  ...
  const date: number = __ecma262_MakeDate(
    __ecma262_Day(t),
    __ecma262_MakeTime(__ecma262_HourFromTime(t), __ecma262_MinFromTime(t), s, milli),
  );
