...
import { analyzeBugPatterns, closeBAM, initBAM, scanDirectory } from "./bam.js"
import {
...
async function main() {
  ...
  await runMutationTesting("./compiler/semantic.js", "node test_semantic.js")

  // Test run_micro_tests.js mutations
  console.log("\n📍 Testing run_micro_tests.js")
  await runMutationTesting("./run_micro_tests.js", "node run_micro_tests.js")
