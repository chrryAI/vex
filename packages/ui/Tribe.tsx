...
// Memoized to prevent re-renders of the entire list when a single post changes
const TribePostListItem = React.memo(
  ({
    post,
    index,
    reduceMotion,
    ...
    const imageWidth = viewPortWidth < 500 ? "100%" : isMobileDevice ? 300 : 200
    const imageHeight =
      viewPortWidth < 500 ? "auto" : isMobileDevice ? 300 : 200
    const videoWidth = viewPortWidth < 500 ? "100%" : isMobileDevice ? 375 : 275
...
TribePostListItem.displayName = "TribePostListItem"
