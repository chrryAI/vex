...
// ⚡ Bolt: Wrap TribePostListItem in React.memo() to prevent expensive re-renders
// when the parent Tribe component re-renders (e.g. from scrolling or new data)
// but the individual post's props haven't changed.
