...
vi.mock("../hooks/useUserScroll", () => ({
    useUserScroll: () => ({ isUserScrolling: false, hasStoppedScrolling: true, resetScrollState: vi.fn() }),
}))
...
vi.mock("../Messages", () => ({ default: () => <div data-testid="messages-list" /> }))
vi.mock("../Chat", () => ({ default: () => <div data-testid="chat-input" /> }))
vi.mock("../Loading", () => ({ default: () => <div data-testid="loading" /> }))
vi.mock("../DeleteThread", () => ({ default: () => <div data-testid="delete-thread" /> }))
vi.mock("../EditThread", () => ({ default: () => <div data-testid="edit-thread" /> }))
vi.mock("../Share", () => ({ default: () => <div data-testid="share-thread" /> }))
vi.mock("../Instructions", () => ({ default: () => <div data-testid="instructions" /> }))
vi.mock("../Bookmark", () => ({ default: () => <div data-testid="bookmark" /> }))
vi.mock("../CollaborationStatus", () => ({ default: () => <div data-testid="collaboration-status" /> }))
vi.mock("../EnableSound", () => ({ default: () => <div data-testid="enable-sound" /> }))
vi.mock("../MemoryConsent", () => ({ default: () => <div data-testid="memory-consent" /> }))
vi.mock("../Skeleton", () => ({ default: ({ children }: any) => <div data-testid="skeleton">{children}</div> }))
vi.mock("../Focus", () => ({ default: () => <div data-testid="focus-mode" /> }))
vi.mock("../Tribe", () => ({ default: ({ children }: any) => <div data-testid="tribe">{children}</div> }))
...
describe("Thread", () => {
    ...
    it("renders thread skeleton and components", async () => {
        ...
        expect(container.querySelector("[data-testid='messages-list']")).toBeTruthy()
    ...
    it("renders header actions when not a visitor", async () => {
        ...
        const instructions = container.querySelector("[data-testid='thread-instruction']")
        if (instructions) expect(instructions).toBeTruthy()

        const deleteThread = container.querySelector("[data-testid='delete-thread']")
