...
vi.mock("../platform", async (importOriginal) => {
    ...
    return {
        ...
        Input: ({ ...props }: any) => <input {...props} data-testid={props["data-testid"] || props.dataTestId} />,
...
vi.mock("../Modal", () => ({ default: ({ children, isModalOpen, onToggle }: any) => isModalOpen ? <div data-testid="modal"><button data-testid="close-modal" onClick={() => onToggle(false)}>Close</button>{children}</div> : null }))
vi.mock("../Loading", () => ({ default: () => <div data-testid="loading" /> }))
vi.mock("../Image", () => ({ default: () => <div data-testid="image" /> }))
vi.mock("../Select", () => ({ default: (props: any) => <select {...props} data-testid={props["data-testid"] || props.dataTestId} /> }))
vi.mock("../Checkbox", () => ({ default: ({ children, ...props }: any) => <div data-testid={props.dataTestId}><input type="checkbox" {...props} />{children}</div> }))
vi.mock("../ColorScheme", () => ({ default: () => <div data-testid="color-scheme" /> }))
vi.mock("../ThemeSwitcher", () => ({ default: () => <div data-testid="theme-switcher" /> }))
vi.mock("../TribeCalculator", () => ({ TribeCalculator: () => <div data-testid="tribe-calculator" /> }))
...
describe("Agent", () => {
    ...
    it("renders settings button", async () => {
        ...
        const button = container.querySelector("[data-testid='app-settings-button']")
    ...
    it("verifies setAppStatus is called when settings button is clicked", async () => {
        ...
        const settingsButton = container.querySelector("[data-testid='app-settings-button']")
    ...
    it("switches to extend tab", async () => {
        ...
        expect(container.querySelector("[data-testid='visibility-select']")).toBeTruthy()
        expect(container.querySelector("[data-testid='calendar-checkbox']")).toBeTruthy()
    })
    ...
    it("switches to api tab", async () => {
        ...
        */
        ...
        expect(container.querySelector("[data-testid='openai-api-key']")).toBeTruthy()
    })
})
