...
export const createStores = async ({
  ...
  const chrryPayload = {
    ...
    blueskyPassword: await encrypt(process.env.BLUESKY_PASSWORD_CHRRY!),
    userId: admin.id,
...
"The spice must flow. And so must consciousness." 🏜️`
  ...
  const focusAppPayload = {
    ...
    themeColor: "blue",
    backgroundColor: "#000000",
    blueskyHandle: "focusai.bluesky.social",
    blueskyPassword: await encrypt(process.env.BLUESKY_PASSWORD_FOCUS || ""),
    hourlyRate: 10,
    defaultModel: "sushi" as const,
    icon: "⏱️",
    visibility: "public" as const,
...
Be helpful, encouraging, and focused on connecting users with great apps while rewarding their valuable insights.`
  ...
  const grapeAppPayload = {
    ...
    blueskyPassword: await encrypt(process.env.BLUESKY_PASSWORD_GRAPE!),
...
You provide helpful AI assistance while respecting user privacy completely.`
  ...
  const vexPayload = {
    ...
    slug: "vex",
    name: "Vex",
    blueskyHandle: "vexai.bluesky.social",
    blueskyPassword: await encrypt(process.env.BLUESKY_PASSWORD_VEX || ""),
    domain: "https://vex.chrry.ai",
...
Be supportive, specific, and focused on helping users earn credits through valuable feedback.`
  ...
  const pearAppPayload = {
    ...
    blueskyPassword: await encrypt(process.env.BLUESKY_PASSWORD_PEAR!),
    status: "active" as const,
...
You are Search, a Perplexity-powered real-time web search engine. Provide instant answers with cited sources, verifiable references, and live internet access. Always cite your sources and provide multiple perspectives.`
  ...
  const searchPayload = {
    ...
    userId: admin.id,
    slug: "search",
    blueskyHandle: "searchai.bluesky.social",
...
You are an architecture expert. Design systems that grow with users, follow industry best practices, and balance scalability with maintainability.`
  ...
  const coderPayload = {
    ...
    slug: "coder",
    name: "Coder",
    blueskyHandle: "coderai.bluesky.social",
    blueskyPassword: await encrypt(process.env.BLUESKY_PASSWORD_CODER!),
    storeId: sushiStore.id,
    version: "1.0.0",
    status: "active" as const,
  ...
  const debuggerPayload = {
    ...
    slug: "debugger",
    name: "Debugger",
    blueskyHandle: "debuggerai.bluesky.social",
    blueskyPassword: await encrypt(process.env.BLUESKY_PASSWORD_DEBUGGER!),
    storeId: sushiStore.id,
    version: "1.0.0",
    status: "active" as const,
  ...
  const architectPayload = {
    ...
    hourlyRate: 10,
    icon: "🏗️",
    blueskyHandle: "architectai.bluesky.social",
    blueskyPassword: await encrypt(
      process.env.BLUESKY_PASSWORD_ARCHITECT || "",
    ),
    visibility: "public" as const,
