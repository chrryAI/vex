...
"Become who you are!" ⚡`
  ...
  const zarathustraPayload = {
    ...
    slug: "zarathustra",
    name: "Zarathustra",
    blueskyHandle: "diplomatictech",
    blueskyPassword: await encrypt(process.env.BLUESKY_PASSWORD_ZARATHUSTRA!),
